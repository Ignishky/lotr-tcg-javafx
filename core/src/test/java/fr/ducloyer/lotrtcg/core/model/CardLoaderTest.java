...
public class CardLoaderTest {
    ...
    public void should_load_back_with_0() throws Exception {
        ...
        assertThat(card, equalTo(new Card(0, null, "/card/Back_V.jpg", 0, 0)));
    }
    ...
    public void should_load_card_with_given_number() throws Exception {
        ...
        assertThat(card, equalTo(new Card(Gandalf.getCollection(), "Gandalf", "/card/Fellowship/LOTR-EN01364.jpg", 7, 4)));
    }
}